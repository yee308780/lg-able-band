...
DEVICE_KEYWORDS: Dict[str, List[str]] = {
    ...
    "LOCATION": ["uwb", "유더블유비", "위치", "어디", "찾아", "가까이"],
    "ALERT": ["알림", "경고", "위험"],
...
PATTERN_KEYWORDS: Dict[str, List[str]] = {
    "TIME_LEFT": ["몇 분", "남았", "얼마", "언제 끝", "다 됐"],
    "UNREAD": ["미확인", "안 읽", "새 알림"],
    "DANGER": ["위험", "긴급", "조심"],
    "RECENT": ["최근", "마지막", "읽어줘"],
    "REPEAT": ["다시", "방금", "못 들었", "한 번 더"],
    "LOCATION": ["위치", "어디", "찾아", "찾기", "거리", "몇 미터", "가까워"],
    "NOTIFY": ["알려줘", "연락", "전화", "보내줘"],
    "DOOR_OPEN": ["열려", "닫혀", "문"],
    "POWER": ["켜져", "꺼져", "전원", "불"],
    "STATUS": ["상태", "어때", "괜찮", "문제", "확인", "연결"],
    "ALERT": ["알림", "경고", "뭐 떴어", "있어"],
    "HELP": ["도움말", "뭐 물어", "사용법", "기능"],
}


INTENT_MAP: Dict[tuple[str, str], str] = {
    ("WASHER", "TIME_LEFT"): "WASHER_TIME_CHECK",
    ("WASHER", "LOCATION"): "LOCATION_CHECK",
    ("WASHER", "STATUS"): "WASHER_STATUS_CHECK",
    ("WASHER", "ALERT"): "WASHER_ALERT_CHECK",
    ("REFRIGERATOR", "LOCATION"): "LOCATION_CHECK",
